 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/ZZ/Documents/ble5_project_zero_cc2640r2lp_app/FlashROM_StackLibrary/configPkg/package/cfg/app_ble_pem3");
...
const __T1_ti_sysbios_knl_Idle_funcList ti_sysbios_knl_Idle_funcList__A[3] = {
    ...
    ((xdc_Void(*)(xdc_Void))((xdc_Fxn)adc)),  /* [2] */
};
